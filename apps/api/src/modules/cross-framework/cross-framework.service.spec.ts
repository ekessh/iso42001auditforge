...
describe('CrossFrameworkService', () => {
  let svc: CrossFrameworkService;
  ...
  beforeEach(() => {
    ...
    const repo = new CrossFrameworkRepository(sql as never, new TenancyAdapter());
    svc = new CrossFrameworkService(repo);
  });
